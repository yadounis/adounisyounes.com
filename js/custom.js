		...
		//SCROLL TO TOP SCRIPT (LINK IN THE FOOTER)
			...
			$('#contact_form input, #contact_form textarea').focus(function(){
				$(this).animate({ backgroundColor: "#d7d7d7", borderBottomColor: "#bcbcbc", borderTopColor: "#bcbcbc", borderLeftColor: "#bcbcbc", borderRightColor: "#bcbcbc"}, 500);
				$(this).parent().find('label').fadeOut('fast');		
			});
			
			//show labels when field is not focused - only if there are no text
			$('#contact_form input, #contact_form textarea').blur(function(){
				$(this).animate({ backgroundColor: "#fefefe", borderBottomColor: "#b9b9b9", borderTopColor: "#b9b9b9", borderLeftColor: "#b9b9b9", borderRightColor: "#b9b9b9"}, 500);
